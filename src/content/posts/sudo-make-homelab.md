...
<svg width="100%" viewBox="0 0 680 662" role="img" style="display:block;margin:2rem 0;">
  ...
  <line x1="340" y1="136" x2="340" y2="158" stroke="#4A8A4A" stroke-width="1.5"/>
  <line x1="340" y1="202" x2="340" y2="224" stroke="#4A8A4A" stroke-width="1.5"/>
  <path d="M442 168 L620 168 L620 462" fill="none" stroke="#4A8A4A" stroke-width="1.5"/>
  <path d="M258 268 L258 290 L76 290 L76 312" fill="none" stroke="#4A8A4A" stroke-width="1.2"/>
  <path d="M290 268 L290 300 L206 300 L206 312" fill="none" stroke="#4A8A4A" stroke-width="1.2"/>
  <path d="M388 268 L388 300 L406 300 L406 312" fill="none" stroke="#4A8A4A" stroke-width="1.2"/>
  <path d="M420 268 L420 290 L536 290 L536 312" fill="none" stroke="#4A8A4A" stroke-width="1.2"/>
  <path d="M600 462 L600 422 L350 422" fill="none" stroke="#4A8A4A" stroke-width="1.5"/>
  <line x1="580" y1="484" x2="350" y2="484" stroke="#4A8A4A" stroke-width="1.2" stroke-dasharray="4 3"/>
  <path d="M575 506 L575 540 L93 540 L93 506" fill="none" stroke="#4A8A4A" stroke-width="1.5"/>

  <ellipse cx="300" cy="38" rx="34" ry="18" fill="#1E2A2E" stroke="#4A7A8A" stroke-width="0.8"/>
  <ellipse cx="330" cy="32" rx="28" ry="16" fill="#1E2A2E" stroke="#4A7A8A" stroke-width="0.8"/>
  <ellipse cx="358" cy="38" rx="26" ry="16" fill="#1E2A2E" stroke="#4A7A8A" stroke-width="0.8"/>
  <ellipse cx="340" cy="48" rx="38" ry="16" fill="#1E2A2E" stroke="#4A7A8A" stroke-width="0.8"/>
  <ellipse cx="300" cy="40" rx="32" ry="14" fill="#1E2A2E" stroke="none"/>
  <ellipse cx="330" cy="34" rx="26" ry="13" fill="#1E2A2E" stroke="none"/>
  <ellipse cx="358" cy="40" rx="24" ry="13" fill="#1E2A2E" stroke="none"/>
  <text x="329" y="44" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="12" fill="#8AAABB">Internet</text>

  <rect x="268" y="100" width="144" height="36" rx="6" fill="#1A2E1A" stroke="#4A8A4A" stroke-width="0.8"/>
  <text x="340" y="118" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="13" font-weight="500" fill="#80C080">Modem</text>

  <rect x="238" y="158" width="204" height="44" rx="6" fill="#1A2E1A" stroke="#4A8A4A" stroke-width="0.8"/>
  <text x="340" y="175" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="13" font-weight="500" fill="#80C080">Router-P</text>
  <text x="340" y="193" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="11" fill="#4A8A4A">Primary · wired star hub</text>

  <rect x="238" y="224" width="204" height="44" rx="6" fill="#1A2E1A" stroke="#4A8A4A" stroke-width="0.8"/>
  <text x="340" y="241" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="13" font-weight="500" fill="#80C080">Ethernet Switch</text>
  <text x="340" y="259" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="11" fill="#4A8A4A">5-port · basement</text>

  <rect x="28" y="312" width="96" height="44" rx="6" fill="#1A3A52" stroke="#318BBF" stroke-width="1"/>
  <text x="76" y="329" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="13" font-weight="500" fill="#8BBFD4">tp-01</text>
  <text x="76" y="347" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="11" fill="#5A8FA8">wired</text>

  <rect x="158" y="312" width="96" height="44" rx="6" fill="#1A3A52" stroke="#318BBF" stroke-width="1"/>
  <text x="206" y="329" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="13" font-weight="500" fill="#8BBFD4">tp-02</text>
  <text x="206" y="347" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="11" fill="#5A8FA8">wired</text>

  <rect x="358" y="312" width="96" height="44" rx="6" fill="#1A3A52" stroke="#318BBF" stroke-width="1"/>
  <text x="406" y="329" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="13" font-weight="500" fill="#8BBFD4">tp-03</text>
  <text x="406" y="347" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="11" fill="#5A8FA8">wired</text>

  <rect x="488" y="312" width="96" height="44" rx="6" fill="#1A3A52" stroke="#318BBF" stroke-width="1"/>
  <text x="536" y="329" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="13" font-weight="500" fill="#8BBFD4">pi5-02</text>
  <text x="536" y="347" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="11" fill="#5A8FA8">wired</text>

  <rect x="556" y="462" width="110" height="44" rx="6" fill="#1A2E1A" stroke="#4A8A4A" stroke-width="0.8"/>
  <text x="611" y="479" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="13" font-weight="500" fill="#80C080">Router-S1</text>
  <text x="611" y="497" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="11" fill="#4A8A4A">Satellite</text>

  <rect x="220" y="400" width="130" height="44" rx="6" fill="#1A3A52" stroke="#318BBF" stroke-width="1"/>
  <text x="285" y="417" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="13" font-weight="500" fill="#8BBFD4">pi5-01</text>
  <text x="285" y="435" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="11" fill="#5A8FA8">wired</text>

  <rect x="28" y="462" width="130" height="44" rx="6" fill="#1A3A52" stroke="#318BBF" stroke-width="1"/>
  <text x="93" y="479" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="13" font-weight="500" fill="#8BBFD4">tb-01</text>
  <text x="93" y="497" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="11" fill="#5A8FA8">wired</text>

  <rect x="220" y="462" width="130" height="44" rx="6" fill="#1A3A52" stroke="#318BBF" stroke-width="1" stroke-dasharray="4 3"/>
...
<svg width="100%" viewBox="0 0 680 720" role="img" style="display:block;margin:2rem 0;">
  ...
  <path d="M290 100 L290 148 L176 148 L176 160" fill="none" stroke="#318BBF" stroke-width="1.2" marker-end="url(#arrow)"/>
  <path d="M390 100 L390 148 L504 148 L504 160" fill="none" stroke="#318BBF" stroke-width="1.2" marker-end="url(#arrow)"/>

  <rect x="90" y="160" width="172" height="54" rx="6" fill="#1A3A52" stroke="#318BBF" stroke-width="1"/>
  <text x="176" y="180" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="13" font-weight="500" fill="#8BBFD4">tp-01</text>
  <text x="176" y="200" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="11" fill="#5A8FA8">K3s worker</text>

  <rect x="418" y="160" width="172" height="54" rx="6" fill="#1A3A52" stroke="#318BBF" stroke-width="1"/>
  ...
  <text x="116" y="326" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="13" font-weight="500" fill="#A89FE8">tb-01</text>
  <text x="116" y="344" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="11" fill="#7A6FC4">Dev node</text>
  <text x="116" y="362" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="11" fill="#7A6FC4">build + push image</text>

  <line x1="202" y1="340" x2="268" y2="340" stroke="#2A9D8F" stroke-width="1.2" marker-end="url(#arrow)"/>

  <rect x="268" y="306" width="172" height="68" rx="6" fill="#0D3D3D" stroke="#2A9D8F" stroke-width="1"/>
  <text x="354" y="326" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="13" font-weight="500" fill="#5ECFC4">tp-02</text>
  <text x="354" y="344" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="11" fill="#3A9D96">Registry · CI runner</text>
  <text x="354" y="362" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="11" fill="#3A9D96">store + serve image</text>
  ...
  <text x="96" y="456" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="12" font-weight="500" fill="#A89FE8">K8s workshop</text>
  <text x="96" y="474" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="11" fill="#7A6FC4">3× KVM VMs</text>

  <rect x="184" y="436" width="140" height="54" rx="6" fill="#1A1630" stroke="#6B5FD4" stroke-width="1"/>
  <text x="254" y="456" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="12" font-weight="500" fill="#A89FE8">Arch Linux VM</text>
  <text x="254" y="474" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="11" fill="#7A6FC4">Course lab</text>

  <rect x="26" y="502" width="298" height="44" rx="6" fill="#0D2E3A" stroke="#2A9DBF" stroke-width="1"/>
  ...
  <text x="439" y="456" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="13" font-weight="500" fill="#5ACFE0">pi5-01</text>
  <text x="439" y="474" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="11" fill="#2A9DBF">AI inference</text>

  <rect x="522" y="436" width="130" height="54" rx="6" fill="#1E2A30" stroke="#4A6A7A" stroke-width="1"/>
  <text x="587" y="456" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="13" font-weight="500" fill="#8AAABB">tp-04</text>
  <text x="587" y="474" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="11" fill="#5A8090">Win11 + WSL</text>

  <rect x="374" y="502" width="278" height="44" rx="6" fill="#0D2E3A" stroke="#2A9DBF" stroke-width="1"/>
  <text x="513" y="520" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="12" font-weight="500" fill="#5ACFE0">Ollama · InstructLab</text>
  <text x="513" y="538" text-anchor="middle" dominant-baseline="central" font-family="JetBrains Mono, monospace" font-size="11" fill="#2A9DBF">Edge inference · M.2 HAT</text>
